...
import mild_icon from './resources/img/icons/mild.png';
      ...
      <div className="container">
        <div className="content__top">
          <div className="categories">
            <ul>
              <li className="active"><img src={all_icon} alt="all"></img>All</li>
              <li><img src={meat_icon} alt="meat"></img>Meat</li>
              <li><img src={vege_icon} alt="vege"></img>Vegetarian</li>
              <li><img src={spicy_icon} alt="spicy"></img>Spicy</li>
              <li><img src={mild_icon} alt="mild"></img>Mild</li>
            </ul>
          </div>
          <div className="sort">
        ...
        <div className="content__items">
          <div className="pizza-block">
            <img
              ...
              alt="Pizza"
            />
            <h4 className="pizza-block__title">4 cheese pizza</h4>
            <div className="pizza-block__description">
              <span> Ingredients: mozzarella, parmesan, dor blue and cheddar </span>
            </div>
